...
import br.com.bijufactory.fornecedor.controller.FornecedorController;
...
public class FormCadastroFornecedor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Informações da Fornecedor"));
    ...
    private void limpaComponetes(){
        ...
        fornecedorController.inicializaObjetos();
    ...
    private void btExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btExcluirActionPerformed
        ...
        int op = JOptionPane.showOptionDialog(null, "Confirma a exclusão do fornecedor?", "Excluindo", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE , null, opcoes, null);
        if(op == JOptionPane.YES_OPTION ){
            fornecedorController.removerMateriaPrima();
            this.limpaComponetes();
        }
    ...
    private void btSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSalvarActionPerformed
        Object opcoes[] = {"Sim","Não"};
        //JDialog.setDefaultLookAndFeelDecorated(true);
        int op = JOptionPane.showOptionDialog(null, "Confirma a gravação do fornecedor?", "Gravando", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE , null, opcoes, null);
        if(op == JOptionPane.YES_OPTION ){
            fornecedorController.getbjFornecedor().setSCodigo(this.getTxSCodigo().getText());
            fornecedorController.getbjFornecedor().setSNome(this.getTxSDescricao().getText());
    ...
    private void txSCodigoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txSCodigoActionPerformed
        ...
        this.limpaComponetes();
        this.habilitaComponentes(true);
        fornecedorController.consultarMateriaPrima(this.txSCodigo.getText());
        this.txSDescricao.setText(fornecedorController.getbjFornecedor().getSNome());
